        ...
        <Card>
            <Card.Body>
                ...
                <ListGroup>
                    ...
                    <ListGroup.Item>
                        <i className="mdi mdi-credit-card-outline me-1"></i> Paypal Payment Gateway
                    </ListGroup.Item>
                </ListGroup>
            </Card.Body>
        </Card>
        ...
        <>
            <Card>
                <Card.Body>
                    ...
                    <p className="sub-header">
                        And if you want <code>&lt;label&gt;</code>s as the <code>.list-group-item</code> for large hit
                        areas, you can do that, too.
                    </p>

                    <ListGroup>
                        <ListGroup.Item>
                            <input className="form-check-input me-1" type="checkbox" value="" aria-label="..." /> First
                            checkbox
                        </ListGroup.Item>
                        <ListGroup.Item>
                            <input className="form-check-input me-1" type="checkbox" value="" aria-label="..." /> Second
                            checkbox
                        </ListGroup.Item>
                        <ListGroup.Item>
                            <input className="form-check-input me-1" type="checkbox" value="" aria-label="..." /> Third
                            checkbox
                        </ListGroup.Item>
                        <ListGroup.Item>
                            <input className="form-check-input me-1" type="checkbox" value="" aria-label="..." /> Fourth
                            checkbox
                        </ListGroup.Item>
                        <ListGroup.Item>
                            <input className="form-check-input me-1" type="checkbox" value="" aria-label="..." /> Fifth
                            checkbox
                        </ListGroup.Item>
                    </ListGroup>
                </Card.Body>
