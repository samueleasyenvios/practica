                        ...
                        <Card.Body>
                            <Row>
                                ...
                                <Col xl={6} className="mt-3 mt-xl-0">
                                    ...
                                    <p className="text-custom">Etiam porta sem malesuada magna mollis euismod.</p>
                                    <p className="text-pink">Donec ullamcorper nulla non metus auctor fringilla.</p>
                                    <p className="text-muted">
                            ...
                            <Row>
                                ...
                                <Col xl={6} className="mt-3 mt-xl-0">
                                    ...
                                    <p className="sub-header">
                                        ...
                                        <code className="highlighter-rouge">.text-truncate</code> class to truncate the
